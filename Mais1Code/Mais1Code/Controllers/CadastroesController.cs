...
using Mais1Code.Data;
using Mais1Code.Views;

namespace Mais1Code.Controllers
{
    public class CadastroesController : Controller
    {
        private readonly Mais1CodeContext _context;

        public CadastroesController(Mais1CodeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Idade,Cidade,Estado,Rua,Numero")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Idade,Cidade,Estado,Rua,Numero")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
